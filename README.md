...
```bash
docker pull ghcr.io/firstdorsal/mattermost-rolling-release:latest
```

Or use a specific version:

```bash
docker pull ghcr.io/firstdorsal/mattermost-rolling-release:11.3.0
```
...
services:
  ...
  mattermost:
    image: ghcr.io/firstdorsal/mattermost-rolling-release:latest
    depends_on:
      - postgres
    environment:
